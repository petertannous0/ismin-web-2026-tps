/*
  ...
  - Added the required column `organisationId` to the `Model` table without a default value. This is not possible if the table is not empty.
...
CREATE TABLE "new_Model" (
    ...
    "license" TEXT,
    CONSTRAINT "Model_organisationId_fkey" FOREIGN KEY ("organisationId") REFERENCES "Organisation" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
